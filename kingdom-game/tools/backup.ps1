...
#   _backups\kingdom-game_20260902-2249.zip  みたいなファイルが1個できる。
...
$zipPath   = Join-Path $backupDir "kingdom-game_$stamp.zip"
...
$tmp = Join-Path $env:TEMP "kingdomgame_backup_$stamp"
...
# 古いバックアップを整理
$all = Get-ChildItem $backupDir -Filter "kingdom-game_*.zip" | Sort-Object Name -Descending
...
Get-ChildItem $backupDir -Filter "kingdom-game_*.zip" |
